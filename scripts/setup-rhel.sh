...
#   2. Installs EPEL and essential administrator tools
...
#   7. Configures firewalld with safe defaults
#
...
# --- OS Check ---
if ! grep -qiE "rhel|centos|almalinux|rocky" /etc/os-release; then
  error "This script is intended for RHEL-based systems (CentOS, AlmaLinux, Rocky) only."
fi

echo ""
echo -e "${BOLD}============================================${NC}"
echo -e "${BOLD}  RHEL/AlmaLinux Server Post-Install Setup ${NC}"
echo -e "${BOLD}============================================${NC}"
...
# =============================================================================
# STEP 2: Install EPEL and Essential Tools
# =============================================================================
step "2/7 — Installing EPEL and Essential Administrator Tools"
info "Installing EPEL repository..."
dnf install -y -q epel-release

TOOLS="htop tmux screen curl wget vim nano git net-tools tree rsync bash-completion lsof unzip fail2ban firewalld"
info "Installing: $TOOLS"
dnf install -y -q $TOOLS
success "EPEL and essential tools installed."
...
# =============================================================================
step "7/7 — Configuring firewalld"
systemctl enable --now firewalld
firewall-cmd --permanent --add-service=ssh
firewall-cmd --permanent --add-service=http
firewall-cmd --permanent --add-service=https
firewall-cmd --reload
success "firewalld enabled with rules: SSH, HTTP, HTTPS allowed."
...
echo -e "  ${GREEN}✓${NC} EPEL + essential tools installed"
